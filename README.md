...
| <a name="input_description"></a> [description](#input\_description) | Description of the secret. | `map(object)` | `{}` | yes |
...
| <a name="input_secrets"></a> [secrets](#input\_secrets) | A map of secrets name and value to be created | `map(object)` | {} | yes |
